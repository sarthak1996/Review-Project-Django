...
class FollowUpPeerTestingUpdateView(UpdateView):
	model=Review
	...
	def get_context_data(self, **kwargs):
		context=super(FollowUpPeerTestingUpdateView,self).get_context_data(**kwargs)
	...
	def dispatch(self, *args, **kwargs):
		return super(FollowUpPeerTestingUpdateView, self).dispatch(*args, **kwargs)
