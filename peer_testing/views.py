...
def peer_testing_home(request):
	...
	dashboard_objects=[]
	raised_by_me_obj=ConfigurationDashboard('Peer testing Raised by me','',peer_testing_raised_by_me_count,'peer_testing:peer_testing_list_view')
	raised_to_me_obj=ConfigurationDashboard('Peer testing raised to me','',peer_testing_raised_to_me_count,'peer_testing:peer_testing_raised_to_me')
